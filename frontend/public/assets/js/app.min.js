...
function initSimulation() {
  var e = Matter.Engine,
    ...
    m = a.rectangle(-80, p / 2, 160, p, { isStatic: !0 }),
    g = a.rectangle(u + 80, p / 2, 160, 1200, { isStatic: !0 }),
    v = a.rectangle(u / 2 + 160, -80, u + 320, 160, { isStatic: !0 }),
  ...
  o.add(c, j),
    (h.mouse = R),
    R.element.removeEventListener("mousewheel", R.mousewheel),
    R.element.removeEventListener("DOMMouseScroll", R.mousewheel);
  let N = !1;
  document.addEventListener("mousedown", () => (N = !0)),
    document.addEventListener("mousemove", () => (N = !1)),
    n.on(j, "mouseup", function (e) {
      var t = e.source,
        n = l.world.bodies;
      if (!t.bodyB)
...
!(function (e, t) {
      ...
      return (
        ...
        (s._addEventListeners = function () {
          ...
          this._config.keyboard &&
            R.on(this._element, "keydown.bs.carousel", function (t) {
              return e._keydown(t);
            }),
            "hover" === this._config.pause &&
              (R.on(this._element, "mouseenter.bs.carousel", function (t) {
                return e.pause(t);
              }),
        ...
        (s._addTouchEventListeners = function () {
          ...
          Y.find(".carousel-item img", this._element).forEach(function (e) {
            ...
            this._pointerEvent
              ? (R.on(this._element, "pointerdown.bs.carousel", function (e) {
                  return t(e);
                }),
              ...
              : (R.on(this._element, "touchstart.bs.carousel", function (e) {
                  return t(e);
                }),
  ...
  R.on(
    ...
    R.on(window, "load.bs.carousel.data-api", function () {
      for (
        ...
        Q.carouselInterface(e[t], S(e[t], "bs.carousel"));
    }),
    b(function () {
      var e = y();
      if (e) {
  ...
  var K = "collapse",
    ...
    ee = (function (e) {
      function r(t, i) {
        ...
        for (
          var r = Y.find('[data-bs-toggle="collapse"]'), s = 0, o = r.length;
          s < o;
          s++
        ) {
          var a = r[s],
        ...
        (s.show = function () {
          ...
          if (
            ...
            if (t) {
              ...
              if ((i = s ? S(s, "bs.collapse") : null) && i._isTransitioning)
                return;
            }
            if (
              ...
              R.one(this._element, "transitionend", function () {
                e._element.classList.remove("collapsing"),
                  ...
                  R.trigger(e._element, "shown.bs.collapse");
              }),
                h(this._element, l),
          ...
          if (
            ...
            R.one(this._element, "transitionend", function () {
              e.setTransitioning(!1),
                ...
                R.trigger(e._element, "hidden.bs.collapse");
            }),
              h(this._element, o);
          }
        }),
  ...
  function Ge(e, t) {
    ...
    var i = t,
      ...
      w = Re(v),
      x = Ye({ reference: w, element: y, strategy: "absolute", placement: r }),
        ...
        (("body" !== ce(t) || Fe(s)) &&
          (l =
            (n = t) !== de(n) && pe(n)
              ...
              : je(n)),
        pe(t)
          ? (((c = Re(t)).x += t.clientLeft), (c.y += t.clientTop))
          : s && (c.x = Ne(s))),
      {
  ...
  var rt = nt(),
    st = nt({ defaultModifiers: [Oe, Ze, Pe, he] }),
    ot = nt({ defaultModifiers: [Oe, Ze, Pe, he, Ke, Xe, Je, Me, Qe] }),
    at = Object.freeze({
      __proto__: null,
      popperGenerator: nt,
      detectOverflow: Ge,
      ...
      return (
        ...
        (s.show = function () {
          if (
            ...
            if (
              !R.trigger(this._element, "show.bs.dropdown", t).defaultPrevented
            ) {
              if (!this._inNavbar) {
                if (void 0 === at)
                  throw new TypeError(
              ...
              "ontouchstart" in document.documentElement &&
                ...
                R.trigger(e, "shown.bs.dropdown", t);
            }
          }
        }),
        (s.hide = function () {
          if (
            ...
            var e = r.getParentFromElement(this._element),
              t = { relatedTarget: this._element };
            R.trigger(e, "hide.bs.dropdown", t).defaultPrevented ||
              (this._popper && this._popper.destroy(),
              this._menu.classList.toggle("show"),
              this._element.classList.toggle("show"),
              R.trigger(e, "hidden.bs.dropdown", t));
          }
        }),
        (s.dispose = function () {
          e.prototype.dispose.call(this),
                ...
                if (
                  ...
                  !(
                    (e &&
                      ...
                      c.contains(e.target)) ||
                    R.trigger(s, "hide.bs.dropdown", a).defaultPrevented
                  )
                )
                  "ontouchstart" in document.documentElement &&
                    (l = []).concat
                    ...
                    R.trigger(s, "hidden.bs.dropdown", a);
              }
            }
        }),
  ...
  R.on(
    ...
    R.on(document, "click.bs.dropdown.data-api", yt.clearMenus),
    R.on(document, "keyup.bs.dropdown.data-api", yt.clearMenus),
    R.on(
      document,
    ...
    wt = (function (e) {
      ...
      return (
        ...
        (s._showElement = function (e) {
          ...
          var r = function () {
            t._config.focus && t._element.focus(),
              ...
              R.trigger(t._element, "shown.bs.modal", { relatedTarget: e });
          };
          if (i) {
        ...
        (s._enforceFocus = function () {
          var e = this;
          R.off(document, "focusin.bs.modal"),
            R.on(document, "focusin.bs.modal", function (t) {
              document === t.target ||
                e._element === t.target ||
        ...
        (s._setEscapeEvent = function () {
          var e = this;
          this._isShown
            ? R.on(this._element, "keydown.dismiss.bs.modal", function (t) {
          ...
          (this._element.style.display = "none"),
            ...
            this._showBackdrop(function () {
              document.body.classList.remove("modal-open"),
                e._resetAdjustments(),
                e._resetScrollbar(),
                R.trigger(e._element, "hidden.bs.modal");
            });
        }),
        ...
        (s._showBackdrop = function (e) {
          ...
          if (this._isShown && this._config.backdrop) {
            if (
              ...
              R.on(this._element, "click.dismiss.bs.modal", function (e) {
  ...
  R.on(
    ...
    function (e) {
      ...
      ("A" !== this.tagName && "AREA" !== this.tagName) || e.preventDefault(),
        R.one(n, "show.bs.modal", function (e) {
          e.defaultPrevented ||
  ...
  var zt = "popover",
    ...
    Rt = i({}, Lt.DefaultType, { content: "(string|element|function)" }),
    jt = {
  ...
  b(function () {
    ...
    if (e) {
      var t = e.fn[zt];
      (e.fn[zt] = Nt.jQueryInterface),
        (e.fn[zt].Constructor = Nt),
    ...
    Vt = (function (e) {
      function r(t, i) {
        ...
        return (
          ...
          (n._scrollHeight = 0),
          R.on(n._scrollElement, "scroll.bs.scrollspy", function (e) {
            return n._process(e);
          }),
          n.refresh(),
          n._process(),
  ...
  R.on(window, "load.bs.scrollspy.data-api", function () {
    ...
    b(function () {
      ...
      if (e) {
        var t = e.fn[Ft];
        (e.fn[Ft] = Vt.jQueryInterface),
          (e.fn[Ft].Constructor = Vt),
      ...
      (r.show = function () {
        ...
        if (
          ...
          if (
            ...
            var o = function () {
              R.trigger(t, "hidden.bs.tab", { relatedTarget: e._element }),
                R.trigger(e._element, "shown.bs.tab", { relatedTarget: t });
            };
          ...
          if (!R.trigger(this._element, "show.bs.toast").defaultPrevented) {
            ...
            var t = function () {
              e._element.classList.remove("showing"),
                ...
                R.trigger(e._element, "shown.bs.toast"),
                e._config.autohide &&
          ...
          if (
            ...
            var t = function () {
              e._element.classList.add("hide"),
                R.trigger(e._element, "hidden.bs.toast");
            };
            if (
    ...
    (t.prototype = {
      ...
      initFill: function () {
        ...
        function h() {
          ...
          (n.width = i.size),
            (n.height = i.size),
            n.getContext("2d").drawImage(t, 0, 0, s, s),
      ...
      drawArc: function (e) {
        if (0 !== e) {
          ...
          t.save(),
            t.beginPath(),
            this.reverse
              ? t.arc(i, i, i - n / 2, r - 2 * Math.PI * e, r)
              : t.arc(i, i, i - n / 2, r, r + 2 * Math.PI * e),
            (t.lineWidth = n),
            ...
            .animate(
              ...
              e.extend({}, this.animation, {
                step: function (e) {
                  ...
                  i.drawFrame(r),
                    n.trigger("circle-animation-progress", [e, r]);
                },
              })
            )
            .promise()
  ...
  (function (e, t) {
    ...
    function g(e) {
      ...
      for (i = e.length; i--; )
        (e[i] && (e[i]._gsap || (e[i]._gsap = new Gt(e[i], t)))) ||
          e.splice(i, 1);
      return e;
    }
    function v(e) {
    ...
    function H(e, t, i, n) {
      return (
        t.parent && z(t),
        (t._start = w(
          (s(i) ? i : i || e !== _e ? Ct(e, i, t) : e._time) + t._delay
        )),
        (t._end = w(
        ...
        function (t) {
          ...
          return At(
            ...
            i.querySelectorAll
              ? i
              : i === e
              ? h("Invalid scope") || Se.createElement("div")
              : e
          );
        }
      );
      ...
      return (
        ...
        function (e, n, r) {
          ...
          if (!S) {
            ...
            for (
              S = l[x] = [],
                a = d ? Math.min(_, x) * p - 0.5 : s % _,
                c = _ === Xe ? 0 : d ? (x * h) / _ - 0.5 : (s / _) | 0,
                b = Xe,
                v = y = 0;
              v < x;
              v++
    ...
    function le(e, t, i) {
      var n,
        ...
        p,
        h,
        f = e ? (s(e) ? [e >> 16, (e >> 8) & Ot, e & Ot] : 0) : Lt.black;
      if (!f) {
    ...
    function he(e, t, i, n) {
      ...
      return (
        b(e, function (e) {
          for (var t in ((jt[e] = dt[e] = s),
          (jt[(r = e.toLowerCase())] = i),
          s))
            jt[
    ...
    var ve,
      ...
      Tt = { _start: 0, endTime: m, totalDuration: m },
      Ct = function e(t, i, r) {
        var s,
          o,
          a,
          ...
          ? ((o = i.charAt(0)),
            ...
            "<" === o || ">" === o
              ...
              : ((o = parseFloat(i.charAt(s - 1) + i.substr(s + 1))),
                a && r && (o = (o / 100) * (it(r) ? r[0] : r).totalDuration()),
      ...
      At = function (e, t, i) {
        return be && !t && be.selector
          ...
          ? it(e)
            ...
            ? [e]
            : []
          : kt.call((t || Se).querySelectorAll(e), 0);
      },
      ...
      Bt =
        ...
        (Oe = {
          ...
          wake: function () {
            Te &&
              (!xe &&
                ...
                (Se = we.document || {}),
                (dt.gsap = Bi),
                (we.gsapVersions || (we.gsapVersions = [])).push(Bi.version),
                u(Ee || we.GreenSockGlobals || (!we.gsap && we) || {}),
                (Ie = we.requestAnimationFrame)),
              Ae && Oe.sleep(),
              (Pe =
                Ie ||
                function (e) {
          ...
          sleep: function () {
            (Ie ? we.cancelAnimationFrame : clearTimeout)(Ae),
              (ke = 0),
              (Pe = m);
          },
    ...
    function qt(e) {
      return e < qe
        ...
        ? Ve * Math.pow(e - 1.5 / 2.75, 2) + 0.75
        : e < 0.9090909090909092
        ? Ve * (e -= 2.25 / 2.75) * e + 0.9375
        : Ve * Math.pow(e - 2.625 / 2.75, 2) + 0.984375;
    }
    ...
    var Yt,
      ...
      Xt =
        (((Yt = $t.prototype).delay = function (e) {
          return e || 0 === e
            ? (this.parent &&
        ...
        (Yt.totalTime = function (e, t) {
          ...
          if (i && i.smoothChildTiming && this._ts) {
            for (F(this, e), !i._dp || i.parent || W(i, this); i && i.parent; )
              i.parent._time !==
                i._start +
                  (0 <= i._ts
                    ? i._tTime / i._ts
        ...
        (Yt.startTime = function (e) {
          if (arguments.length) {
            ...
            return (
              !t || (!t._sort && this.parent) || H(t, this, e - this._delay),
              this
            );
          }
          return this._start;
    ...
    var Ut = (function (e) {
      ...
      return (
        ...
        (a.staggerFrom = function (e, t, i, n, r, s, o) {
          return (
            (i.runBackwards = 1),
            (I(i).immediateRender = l(i.immediateRender)),
        ...
        (a.staggerFromTo = function (e, t, i, n, r, s, o, a) {
          return (
            (n.startAt = i),
            (I(n).immediateRender = l(n.immediateRender)),
          ...
          if (
            ...
            if (
              ...
              this._initted ||
                ...
                (this._zTime = e),
                (m = 0)),
              !m && n && !t && (It(this, "onStart"), this._tTime !== y))
            )
              return this;
            if (m <= n && 0 <= e)
              for (r = this._first; r; ) {
              ...
              for (var S = e < 0 ? e : n; r; ) {
                if (
                  ((s = r._prev), (r._act || S <= r._end) && r._ts && c !== r)
                ) {
                  if (r.parent !== this) return this.render(e, t, i);
                  if (
                    (r.render(
        ...
        (a.addPause = function (e, t, i) {
          ...
          return (
            (n.data = "isPause"), (this._hasPause = 1), H(this, n, Ct(this, e))
          );
        }),
            ...
            for (n = s.parent; o; )
              (t = o._prev),
                ...
                a < (i = o._start) && s._sort && o._ts && !s._lock
                  ? ((s._lock = 1), (H(s, o, i - o._delay, 1)._lock = 0))
                  : (a = i),
                i < 0 &&
                  o._ts &&
                  ((r -= i),
    ...
    function Qt(e, t, i, s, o, l) {
      ...
      if (
        ...
        ((i._pt = d = new bi(i._pt, o, e, 0, 1, c.render, c, 0, c.priority)),
        i !== Me)
      )
    ...
    var Zt,
        ...
        if (
          ...
          return isNaN(m * s) || "" === s
            ? (f || t in e || p(t, s),
              ...
              }.call(this, e, t, m, s, g, c || Ye.stringFilter, d))
            : ((h = new bi(
                this._pt,
                e,
                t,
      ...
      ti = function e(t, i, n) {
        ...
        if (
          (!H || (L && w) || (w = "none"),
          (t._ease = Ht(w, Ge.ease)),
          (t._yEase = O ? Wt(Ht(!0 === O ? w : O, Ge.ease)) : 0),
          O &&
            t._yoyo &&
            !t._repeat &&
            ((O = t._yEase), (t._yEase = t._ease), (t._ease = O)),
          (t._from = !H && !!_.runBackwards),
          !H || (L && !_.stagger))
        ) {
          if (
            ((y = (p = j[0] ? v(j[0]).harness : 0) && _[p.prop]),
            (r = P(_, ft)),
            R &&
            ...
            if (
              ...
              (t._startAt._dp = 0),
              (t._startAt._sat = t),
              i < 0 && (ye || (!S && !D)) && t._startAt.revert(pt),
              S && B && i <= 0 && n <= 0)
            )
          ...
          for (
            t._pt = t._ptCache = 0, T = (B && l(T)) || (T && !B), s = 0;
            s < j.length;
            s++
          ) {
            if (
              ((u = (c = j[s])._gsap || g(j)[s]._gsap),
              (t._ptLookup[s] = f = {}),
              gt[u.id] && mt.length && E(),
              (m = F === j ? s : F.indexOf(c)),
              p &&
                !1 !== (h = new p()).init(c, y || r, t, m, F) &&
                ((t._pt = a =
                  new bi(t._pt, c, h.name, 0, 1, h.render, h, 0, h.priority)),
              ...
              for (o in r)
                vt[o] && (h = Qt(o, r, t, m, c, F))
                  ? h.priority && (d = 1)
                  : (f[o] = a =
                      ei.call(t, c, o, "get", r[o], m, F, 0, _.stringFilter));
            t._op && t._op[s] && t.kill(c, t._op[s]),
              W &&
                t._pt &&
                ((Zt = t),
                _e.killTweensOf(c, f, t.globalTime(i)),
                (b = !t.parent),
                (Zt = 0)),
              t._pt && T && (gt[u.id] = 1);
          }
    ...
    var si = (function (e) {
      function r(t, n, r, o) {
        ...
        var u,
          ...
          b,
          _,
          x = (c = e.call(this, o ? n : I(n)) || this).vars,
          S = x.duration,
          E = x.delay,
          T = x.immediateRender,
          C = x.stagger,
          ...
          if (
            ...
            for (p = 0; p < m; p++)
              ((f = P(n, ri)).stagger = 0),
                ...
                _ && xt(f, _),
                (y = B[p]),
                (f.duration = +ii(S, i(c), p, y, B)),
                (f.delay = (+ii(E, i(c), p, y, B) || 0) - c._delay),
                !C &&
                  1 === m &&
                  f.delay &&
                  ((c._delay = E = f.delay), (c._start += E), (f.delay = 0)),
                u.to(y, f, b ? b(p, y, B) : 0),
                (u._ease = jt.none);
            u.duration() ? (S = E = 0) : (c.timeline = 0);
          } else if (A) {
            I(k(u.vars.defaults, { ease: "none" })),
        ...
        return (
          !0 !== M || ve || ((Zt = i(c)), _e.killTweensOf(B), (Zt = 0)),
          H(D, i(c), r),
          ...
          (T ||
            (!S &&
              ...
              "nested" !== D.data)) &&
            ((c._tTime = -$e), c.render(Math.max(0, -E) || 0)),
          L && V(i(c), L),
          c
        );
      }
          ...
          if (f) {
            if (
              ...
              if (
                ...
                n && !p && !t && (It(this, "onStart"), this._tTime !== g))
              )
                return this;
              ...
              (d &&
                ...
                this._onUpdate &&
                  !t &&
                  (m && B(this, e, 0, i), It(this, "onUpdate")),
                this._repeat &&
                  s !== a &&
                  this.vars.onRepeat &&
                  !t &&
                ...
                (g !== this._tDur && g) ||
                  ...
                  t ||
                    (m && !p) ||
                    !(g || p || l) ||
                    (It(this, g === h ? "onComplete" : "onReverseComplete", !0),
                    !this._prom ||
                ...
                for (
                  ...
                  if ((a = c[d][t]) && a.d && a.d._pt)
                    for (a = a.d._pt; a && a.p !== t && a.fp !== t; )
                      a = a._next;
                  if (!a)
                    return (Jt = 1), (e.vars[t] = "+=0"), ti(e, o), (Jt = 0), 1;
                  u.push(a);
                }
              for (d = u.length; d--; )
                ((a = (l = u[d])._pt || l).s =
          ...
          if (this.timeline) {
            ...
            return (
              ...
              this.parent &&
                ...
                Y(this, (this._dur * this.timeline._tDur) / i, 0, 1),
              this
            );
          }
          var r,
    ...
    var Si,
      ...
      Mi = 0,
      ki =
        (((Si = Ai.prototype).add = function (e, t, i) {
          function n() {
            var e,
              n = be,
              o = s.selector;
    ...
    var Pi,
      Ii =
        (((Pi = Oi.prototype).add = function (e, t, i) {
          a(e) || (e = { matches: e });
          var n,
            r,
            s,
            ...
            ? ((d[u ? "width" : "height"] = 100 + (f ? c : n)),
              ...
              !o.uncache
                ...
                : ((!m && "%" !== c) ||
                  ...
                  s.removeChild(Tn),
                  (d.position = "absolute"),
                  u && m && (((o = v(s)).time = Bt.time), (o.width = s[h])),
      ...
      if (t.tween && t.tween._time === t.tween._dur) {
        ...
        if ("all" === a || !0 === a) (o.cssText = ""), (n = 1);
          ...
          for (r = (a = a.split(",")).length; -1 < --r; )
            (i = a[r]),
              Xn[i] && ((n = 1), (i = "transformOrigin" === i ? ir : tr)),
              an(s, i);
        n &&
          (an(s, tr),
          l &&
      ...
      return o.svg && e.getAttribute("transform")
        ...
        : (l !== dr ||
            ...
            ((i = e.parentNode) && e.offsetParent) ||
              ((s = 1), (n = e.nextElementSibling), Sn.appendChild(e)),
            (l = fn(e)),
    ...
    function gn(e, t, i, n, r, s) {
      ...
      i
        ? d !== dr &&
          (a = m * y - g * v) &&
          ((l = x * (-g / a) + S * (m / a) - (m * _ - g * b) / a),
          (x = x * (y / a) + S * (-v / a) + (v * _ - y * b) / a),
          (S = l))
    ...
    function yn(e, t, i, r, s) {
      ...
      return (
        ...
        (e._pt = a = new bi(e._pt, t, i, r, d, ji)),
        (a.e = u),
        (a.u = "deg"),
        e._props.push(i),
        a
    ...
    function _n(e, t, i) {
      ...
      Xn))
        (s = d[r]) !== (o = n[r]) &&
          ...
          (l = parseFloat(o)),
          (e._pt = new bi(e._pt, n, r, a, l - a, Ri)),
          (e._pt.u = c || 0),
          e._props.push(r));
      bn(n, d);
    }
    ...
    var wn,
      ...
      pr = function (e, t) {
        ...
        return (
          ...
          i.svg &&
            ((M = i.uncache
              ? ((k = e.getBBox()),
                (F = i.xOrigin - k.x + "px " + (i.yOrigin - k.y) + "px"),
                "")
              : !t && e.getAttribute("data-svg-origin")),
            gn(e, M || F, !!M || i.originIsAbsolute, !1 !== i.smooth, g)),
          (f = i.xOrigin || 0),
          (m = i.yOrigin || 0),
          g !== dr &&
            ((w = g[0]),
            ...
            6 === g.length
              ...
              : ((D = g[6]),
                ...
                (c = (v = Qn(D, O)) * $n),
                v &&
                  ((M = T * (y = Math.cos(-v)) + P * (b = Math.sin(-v))),
                  (k = C * y + I * b),
                  (A = D * y + O * b),
                  (P = T * -b + P * y),
                  (I = C * -b + I * y),
                ...
                c &&
                  ...
                  ((c = l = 0), (d = 180 - d)),
                (o = _(Math.sqrt(w * w + x * x + S * S))),
                (a = _(Math.sqrt(C * C + D * D))),
                (v = Qn(T, C)),
          ...
          (i.zOrigin = parseFloat(F.split(" ")[2]) || 0) && (B[ir] = hr(F)),
          (i.xOffset = i.yOffset = 0),
          (i.force3D = Ye.force3D),
          (i.renderTransform = i.svg ? br : kn ? yr : fr),
          (i.uncache = 0),
          i
        );
      },
      ...
      yr = function (e, t) {
        ...
        m !== gr && (b += "perspective(" + m + vr),
          ...
          c !== mr && (b += "rotateY(" + c + vr),
          d !== mr && (b += "rotateX(" + d + vr),
          (u === mr && p === mr) || (b += "skew(" + u + ", " + p + vr),
          (1 === h && 1 === f) || (b += "scale(" + h + ", " + f + vr),
      ...
      br = function (e, t) {
        ...
        (p = parseFloat(p)),
          ...
          ((E && !~(d + "").indexOf("px")) ||
            (T && !~(u + "").indexOf("px"))) &&
            ((E = cn(v, "x", d, "px")), (T = cn(v, "y", u, "px"))),
          (y || b || w || x) &&
            ((E = _(E + y - (y * i + b * r) + w)),
            (T = _(T + b - (y * n + b * s) + x))),
          (l || c) &&
            ((E = _(E + (l / 100) * (o = v.getBBox()).width)),
            (T = _(T + (c / 100) * o.height))),
          (o =
            "matrix(" +
            i +
            "," +
            ...
            if (
              ...
              if (
                ...
                (o = (getComputedStyle(e).getPropertyValue(h) + "").trim()),
                  ...
                  this.add(T, "setProperty", o, a, r, s, 0, 0, h),
                  E.push(h),
                  S.push(h, 0, T[h]);
              else if ("undefined" !== d) {
                if (
                ...
                if (
                  v ||
                  ((l || 0 === l) && (c || 0 === c) && !Jn.test(a) && h in T)
                )
                  (l = l || 0),
                    (f = (o + "").substr((c + "").length)) !==
                      (m = U(a) || (h in Ye.units ? Ye.units[h] : f)) &&
                      (c = cn(e, h, o, m)),
                    (this._pt = new bi(
                      this._pt,
                      v ? b : T,
                ...
                v || (h in T ? S.push(h, 0, T[h]) : S.push(h, 1, o || e[h])),
                  E.push(h);
              }
          w && yi(this);
        },
        ...
        getInline: function (i, n) {
          if ((A(), i.src)) {
            ...
            if (s.length) {
              ...
              o &&
                o.tagName &&
                (C || ((T = r.hiddenClass), (C = w(T)), (T = "mfp-" + T)),
                (M = s.after(C).detach().removeClass(T))),
    ...
    })(
      {
            ...
            !(function () {
              ...
              (n.set = function (e, t, i) {
                ...
                (n.setVertices = function (e, t) {
                  ...
                  r.translate(e.vertices, i, -1),
                    n.setInertia(
                      e,
                      n._inertiaScale * r.inertia(e.vertices, e.mass)
                    ),
                ...
                (n.setPosition = function (e, t) {
                  ...
                  for (var n = 0; n < e.parts.length; n++) {
                    ...
                    (o.position.x += i.x),
                      (o.position.y += i.y),
                      r.translate(o.vertices, i),
                      l.update(o.bounds, o.vertices, e.velocity);
                  }
                }),
                (n.setAngle = function (e, t) {
                  ...
                  for (var n = 0; n < e.parts.length; n++) {
                    var o = e.parts[n];
                    (o.angle += i),
                      r.rotate(o.vertices, i, e.position),
                      c.rotate(o.axes, i),
                      l.update(o.bounds, o.vertices, e.velocity),
                      n > 0 &&
                        s.rotateAbout(o.position, i, e.position, o.position);
                  }
                }),
                (n.setVelocity = function (e, t) {
                  (e.positionPrev.x = e.position.x - t.x),
                    ...
                    (e.velocity.x = t.x),
                    (e.velocity.y = t.y),
                    (e.speed = s.magnitude(e.velocity));
                }),
                ...
                (n.scale = function (e, i, s, o) {
                  for (var a = 0; a < e.parts.length; a++) {
                    var d = e.parts[a];
                    r.scale(d.vertices, i, s, e.position),
                      ...
                      e.isStatic ||
                        ...
                        n.setInertia(d, r.inertia(d.vertices, d.mass)),
                        r.translate(d.vertices, {
                          x: d.position.x,
                          y: d.position.y,
                        })),
                ...
                (n.update = function (e, t, i, n) {
                  ...
                  (e.velocity.x = d * a * n + (e.force.x / e.mass) * o),
                    (e.velocity.y = u * a * n + (e.force.y / e.mass) * o),
              ...
              var t = function (e) {
                for (
                  ...
                  (t.mass += n.mass),
                    ...
                    (t.centre = s.add(
                      t.centre,
                      s.mult(n.position, n.mass !== 1 / 0 ? n.mass : 1)
                    ));
                }
                return (
                  (t.centre = s.div(
          ...
          function (e, t, i) {
            ...
            (n.create = function (e) {
              ...
              (n.setModified = function (e, t, i, r) {
                if (
                  ((e.isModified = t),
                  i && e.parent && n.setModified(e.parent, t, i, r),
                  r)
                )
              ...
              (n.removeComposite = function (e, t, i) {
                ...
                if (
                  (-1 !== r &&
                    (n.removeCompositeAt(e, r), n.setModified(e, !0, !0, !1)),
                  i)
                )
                  for (var o = 0; o < e.composites.length; o++)
                    n.removeComposite(e.composites[o], t, !0);
                return e;
              }),
              ...
              (n.removeBody = function (e, t, i) {
                ...
                if (
                  (-1 !== r &&
                    (n.removeBodyAt(e, r), n.setModified(e, !0, !0, !1)),
                  i)
                )
                  for (var o = 0; o < e.composites.length; o++)
                    n.removeBody(e.composites[o], t, !0);
                return e;
              }),
              ...
              (n.removeConstraint = function (e, t, i) {
                ...
                if ((-1 !== r && n.removeConstraintAt(e, r), i))
                  for (var o = 0; o < e.composites.length; o++)
                    n.removeConstraint(e.composites[o], t, !0);
                return e;
              }),
              ...
              (n.translate = function (e, t, i) {
                for (
                  var r = i ? n.allBodies(e) : e.bodies, s = 0;
                  s < r.length;
                  s++
                )
                  o.translate(r[s], t);
              ...
              (n.scale = function (e, t, i, r, s) {
                for (
                  var a = s ? n.allBodies(e) : e.bodies, l = 0;
                  l < a.length;
                  l++
                ) {
                  var c = a[l],
                    d = c.position.x - r.x,
                    u = c.position.y - r.y;
                  o.setPosition(c, { x: r.x + d * t, y: r.y + u * i }),
                    o.scale(c, t, i);
                }
                return n.setModified(e, !0, !0, !1), e;
              });
              ...
              for (var i = [], a = t.pairs.table, l = 0; l < e.length; l++) {
                ...
                if (
                  ...
                  for (
                    ...
                    for (
                      var p = c.parts[u], h = d.parts.length > 1 ? 1 : 0;
                      h < d.parts.length;
                      h++
                    ) {
                      var f = d.parts[h];
                ...
                (n.update = function (i, n, r, s) {
                  ...
                  for (o = 0; o < n.length; o++) {
                    ...
                    if (
                      (!b.isSleeping || s) &&
                      !(
                        b.bounds.max.x < g.bounds.min.x ||
                        b.bounds.min.x > g.bounds.max.x ||
                        b.bounds.max.y < g.bounds.min.y ||
                        b.bounds.min.y > g.bounds.max.y
                      )
                    ) {
                      var _ = t(i, b);
            ...
            (n.create = function (e) {
              ...
              (n.update = function (e, t, i) {
                var n,
                  ...
                  f = [];
                for (
                  u.length = 0, p.length = 0, h.length = 0, l = 0;
                  l < t.length;
                  l++
                )
                  (n = t[l]).collided &&
                    ((o = r.id(n.bodyA, n.bodyB)),
                    f.push(o),
                    (a = d[o])
                      ? (a.isActive ? h.push(a) : u.push(a), r.update(a, n, i))
                      : ((a = r.create(n, i)),
                        (d[o] = a),
                        u.push(a),
                        c.push(a)));
              ...
              (n.removeOld = function (e, t) {
                ...
                for (s = 0; s < o.length; s++)
                  (n = (i = o[s]).collision).bodyA.isSleeping ||
                  n.bodyB.isSleeping
                    ? (i.timeUpdated = t)
                    : t - i.timeUpdated > 1e3 && l.push(s);
                for (s = 0; s < l.length; s++)
                  delete a[(i = o[(r = l[s] - s)]).id], o.splice(r, 1);
              }),
              (n.clear = function (e) {
                return (
                  (e.table = {}),
              ...
              (n.point = function (e, t) {
                for (var i = [], n = 0; n < e.length; n++) {
                  ...
                  if (o.contains(r.bounds, t))
                    for (
                      var s = 1 === r.parts.length ? 0 : 1;
                      s < r.parts.length;
                      s++
                    ) {
                      var a = r.parts[s];
                      if (
                        o.contains(a.bounds, t) &&
            ...
            (n._restingThresh = 4),
              ...
              (n.solvePosition = function (e, t) {
                ...
                for (i = 0; i < e.length; i++)
                  (r = e[i]).isActive &&
                    ...
                    (c = o.normal),
                    (d = s.sub(
                      s.add(l.positionImpulse, l.position, h),
                      s.add(
                        a.positionImpulse,
                        s.sub(l.position, o.penetration, f),
                        m
                      ),
                      g
                    )),
                    (r.separation = s.dot(c, d)));
                for (i = 0; i < e.length; i++)
                  !(r = e[i]).isActive ||
                    r.isSensor ||
                    r.separation < 0 ||
              ...
              (n.postSolvePosition = function (e) {
                for (var t = 0; t < e.length; t++) {
                  ...
                  if (
                    ((i.totalContacts = 0),
                    0 !== i.positionImpulse.x || 0 !== i.positionImpulse.y)
                  ) {
                    for (var o = 0; o < i.parts.length; o++) {
                      var l = i.parts[o];
                      r.translate(l.vertices, i.positionImpulse),
                    ...
                    for (
                      ...
                      (p = (u = r[i]).vertex),
                        ...
                        (0 === h && 0 === f) ||
                          ...
                          a.isStatic ||
                            a.isSleeping ||
                            ((m = s.sub(p, a.position, v)),
                            (a.positionPrev.x += g.x * a.inverseMass),
                            (a.positionPrev.y += g.y * a.inverseMass),
                            (a.anglePrev += s.cross(m, g) * a.inverseInertia)),
                          l.isStatic ||
                            l.isSleeping ||
                            ((m = s.sub(p, l.position, v)),
                            (l.positionPrev.x -= g.x * l.inverseMass),
                            (l.positionPrev.y -= g.y * l.inverseMass),
                            (l.anglePrev -= s.cross(m, g) * l.inverseInertia)));
              }),
                  ...
                  if (h.isActive && !h.isSensor) {
                    ...
                    for (var w = 0; w < b.length; w++) {
                      var x = b[w],
                        ...
                        C = s.add(
                          m.velocity,
                          s.mult(s.perp(E), m.angularVelocity),
                          c
                        ),
                        M = s.add(
                          g.velocity,
                        ...
                        L = (1 + h.restitution) * A,
                        z =
                          o.clamp(h.separation + A, 0, 1) *
                          n._frictionNormalMultiplier,
                        D = P,
                        B = 1 / 0;
                      I > h.friction * h.frictionStatic * z * i &&
                        ((B = I), (D = o.clamp(h.friction * O * i, -B, B)));
                      var R = s.cross(E, v),
                        j = s.cross(T, v),
                        N =
                          _ /
                          (m.inverseMass +
                            g.inverseMass +
                            m.inverseInertia * R * R +
                            g.inverseInertia * j * j);
                      if (
                        ((L *= N),
                        (D *= N),
                        A < 0 && A * A > n._restingThresh * i)
                      )
                        x.normalImpulse = 0;
                      else {
                        var F = x.normalImpulse;
                        (x.normalImpulse = Math.min(x.normalImpulse + L, 0)),
                          (L = x.normalImpulse - F);
                      }
                      if (P * P > n._restingThreshTangent * i)
                        x.tangentImpulse = 0;
                      else {
                        var W = x.tangentImpulse;
                        (x.tangentImpulse = o.clamp(
                          x.tangentImpulse + D,
                          -B,
                          B
                        )),
                          (D = x.tangentImpulse - W);
                      }
                      (r.x = v.x * L + y.x * D),
                        (r.y = v.y * L + y.y * D),
                        m.isStatic ||
                          m.isSleeping ||
                          ((m.positionPrev.x += r.x * m.inverseMass),
                          (m.positionPrev.y += r.y * m.inverseMass),
                          (m.anglePrev += s.cross(E, r) * m.inverseInertia)),
                        g.isStatic ||
                          g.isSleeping ||
                          ((g.positionPrev.x -= r.x * g.inverseMass),
                          (g.positionPrev.y -= r.y * g.inverseMass),
                          (g.anglePrev -= s.cross(T, r) * g.inverseInertia));
                    }
                  }
                }
              });
            ...
            !(function () {
              n.collides = function (t, n, o) {
                ...
                if (o) {
                  var p = t.parent,
                    ...
                    f =
                      ...
                      h.speed * h.speed +
                      h.angularSpeed * h.angularSpeed;
                  (u = o && o.collided && f < 0.2), (d = o);
                ...
                if (o && u) {
                  ...
                  if (
                    ((c = e(m.vertices, g.vertices, v)),
                    (d.reused = !0),
                    c.overlap <= 0)
                  )
                    return (d.collided = !1), d;
                } else {
                  if ((a = e(t.vertices, n.vertices, t.axes)).overlap <= 0)
                    return (d.collided = !1), d;
                  if ((l = e(n.vertices, t.vertices, n.axes)).overlap <= 0)
                    return (d.collided = !1), d;
                  a.overlap < l.overlap
                    ? ((c = a), (d.axisBody = t))
                    : ((c = l), (d.axisBody = n)),
                ...
                (d.bodyA = t.id < n.id ? t : n),
                  ...
                  (t = d.bodyA),
                  (n = d.bodyB),
                  s.dot(c.axis, s.sub(n.position, t.position)) < 0
                    ? (d.normal = { x: c.axis.x, y: c.axis.y })
                    : (d.normal = { x: -c.axis.x, y: -c.axis.y }),
                  (d.tangent = s.perp(d.normal)),
                ...
                var y = i(t, n, d.normal),
                  b = [];
                if (
                  (r.contains(t.vertices, y[0]) && b.push(y[0]),
                  r.contains(t.vertices, y[1]) && b.push(y[1]),
                  b.length < 2)
                ) {
                  var _ = i(n, t, s.neg(d.normal));
                  r.contains(n.vertices, _[0]) && b.push(_[0]),
                    b.length < 2 &&
                      r.contains(n.vertices, _[1]) &&
                      b.push(_[1]);
                }
              ...
              var e = function (e, i, n) {
                  for (
                    ...
                    if (
                      ...
                      t(a, e, o),
                      t(l, i, o),
                      (r = Math.min(a.max - l.min, l.max - a.min)) <= 0)
                    )
                      return (c.overlap = r), c;
                    r < c.overlap &&
                      ((c.overlap = r), (c.axis = o), (c.axisNumber = d));
                  }
                  return c;
                },
                t = function (e, t, i) {
                  for (
                    var n = s.dot(t[0], i), r = n, o = 1;
                    o < t.length;
                    o += 1
                  ) {
                    var a = s.dot(t[o], i);
                ...
                i = function (e, t, i) {
                  for (
                    ...
                    (r = d[p]),
                      (c.x = r.x - u.x),
                      (c.y = r.y - u.y),
                      (n = -s.dot(i, c)) < l && ((l = n), (o = r));
                  return (
                    (r = d[o.index - 1 >= 0 ? o.index - 1 : d.length - 1]),
                    (c.x = r.x - u.x),
                    (c.y = r.y - u.y),
                    (l = -s.dot(i, c)),
                    (a = r),
                    (r = d[(o.index + 1) % d.length]),
                    (c.x = r.x - u.x),
                    (c.y = r.y - u.y),
                    (n = -s.dot(i, c)) < l && (a = r),
                    [o, a]
            ...
            !(function () {
              ...
              (n.create = function (t) {
                ...
                (n.solve = function (t, i) {
                  ...
                  n &&
                    !n.isStatic &&
                    ((t.pointA = s.rotate(o, n.angle - t.angleA)),
                    (t.angleA = n.angle)),
                    r &&
                      !r.isStatic &&
                      ((t.pointB = s.rotate(a, r.angle - t.angleB)),
                      (t.angleB = r.angle));
                  var l = o,
                    c = a;
                  if (
                    (n && (l = s.add(n.position, o)),
                    r && (c = s.add(r.position, a)),
                    l && c)
                  ) {
                    var d = s.sub(l, c),
                      u = s.magnitude(d);
                    ...
                    var p = (u - t.length) / u,
                      h = s.div(d, u),
                      f = s.mult(d, 0.5 * p * t.stiffness * i * i);
                    if (!(Math.abs(1 - u / t.length) < 0.001 * i)) {
                      var m, g, v, y, b, _, w, x;
                      n && !n.isStatic
                        ? ((v = {
                          ...
                          (n.velocity.x = n.position.x - n.positionPrev.x),
                          (n.velocity.y = n.position.y - n.positionPrev.y),
                          (n.angularVelocity = n.angle - n.anglePrev),
                          (m = s.add(
                            n.velocity,
                            s.mult(s.perp(v), n.angularVelocity)
                          )),
                          (b = s.dot(v, h)),
                          (w = n.inverseMass + n.inverseInertia * b * b))
                        : ((m = { x: 0, y: 0 }), (w = n ? n.inverseMass : 0)),
                        r && !r.isStatic
                          ? ((y = {
                            ...
                            (g = s.add(
                              r.velocity,
                              s.mult(s.perp(y), r.angularVelocity)
                            )),
                            (_ = s.dot(y, h)),
                            (x = r.inverseMass + r.inverseInertia * _ * _))
                          : ((g = { x: 0, y: 0 }), (x = r ? r.inverseMass : 0));
                      var S = s.sub(g, m),
                        E = s.dot(h, S) / (w + x);
                      E > 0 && (E = 0);
                      var T,
                      ...
                      n &&
                        ...
                        (n.constraintImpulse.x -= f.x),
                        (n.constraintImpulse.y -= f.y),
                        ...
                        r &&
                          ...
                          ((T =
                            ...
                            r.inverseInertia *
                            (1 - t.angularStiffness)),
                          (r.constraintImpulse.x += f.x),
                          (r.constraintImpulse.y += f.y),
                          (r.constraintImpulse.angle -= T),
                          (r.position.x += f.x),
                          (r.position.y += f.y),
                          (r.angle -= T));
                    }
                  ...
                  for (var t = 0; t < e.length; t++) {
                    ...
                    if (0 !== n.x || 0 !== n.y || 0 !== n.angle) {
                      ...
                      for (var c = 0; c < i.parts.length; c++) {
                        var d = i.parts[c];
                        r.translate(d.vertices, n),
                          c > 0 &&
                            ((d.position.x += n.x), (d.position.y += n.y)),
                          0 !== n.angle &&
                            (r.rotate(d.vertices, n.angle, i.position),
                          ...
                          a.update(d.bounds, d.vertices, i.velocity);
                      }
              ...
              (n.create = function (t, i) {
                ...
                r ||
                  (t && t.render && t.render.canvas
                    ? (r = o.create(t.render.canvas))
                    : i && i.element
                    ? (r = o.create(i.element))
                    : ((r = o.create()),
                      u.warn(
                  ...
                  if (0 === i.button) {
                    if (n.bodyB) s.set(n.bodyB, !1), (n.pointA = i.position);
                      ...
                      for (var c = 0; c < t.length; c++)
                        if (
                          ((o = t[c]),
                          p.contains(o.bounds, i.position) &&
                            l.canCollide(o.collisionFilter, e.collisionFilter))
                        )
                          for (
                            var d = o.parts.length > 1 ? 1 : 0;
                            d < o.parts.length;
                            d++
                          ) {
                            var u = o.parts[d];
                    ...
                    (n.bodyB = e.body = null),
                      (n.pointB = null),
                      o && a.trigger(e, "enddrag", { mouse: i, body: o });
                });
              var e = function (e) {
                var t = e.mouse,
                  i = t.sourceEvents;
                i.mousemove && a.trigger(e, "mousemove", { mouse: t }),
                  i.mousedown && a.trigger(e, "mousedown", { mouse: t }),
                  i.mouseup && a.trigger(e, "mouseup", { mouse: t }),
        ...
        15: [
          function (e, t, i) {
            ...
            !(function () {
              (n.create = function (e, t) {
                (t = (t = h.isElement(e) ? t : e) || {}),
                  ((e = h.isElement(e) ? e : null) || t.render) &&
                    h.warn(
                ...
                return (
                  ...
                  (n.world = t.world || r.create(n.world)),
                  (n.pairs = l.create()),
                ...
                (n.update = function (n, r, a) {
                  ...
                  var v = { timestamp: f.timestamp };
                  d.trigger(n, "beforeUpdate", v);
                  var y = u.allBodies(h),
                    b = u.allConstraints(h);
                  for (
                    n.enableSleeping && s.update(y, f.timeScale),
                      t(y, h.gravity),
                      i(y, r, f.timeScale, a, h.bounds),
                      c = 0;
                    c < n.constraintIterations;
                    c++
                  )
                    p.solveAll(b, f.timeScale);
                  p.postSolveAll(y),
                    m.controller
                      ? (h.isModified && m.controller.clear(m),
                        m.controller.update(m, y, n, h.isModified),
                        (g = m.pairsList))
                      : (g = y),
                  ...
                  for (
                    l.update(w, _, x),
                      l.removeOld(w, x),
                      n.enableSleeping &&
                        s.afterCollisions(w.list, f.timeScale),
                      w.collisionStart.length > 0 &&
                        d.trigger(n, "collisionStart", {
                          pairs: w.collisionStart,
                        }),
                      o.preSolvePosition(w.list),
                      c = 0;
                    c < n.positionIterations;
                    c++
                  )
                    o.solvePosition(w.list, f.timeScale);
                  for (
                    o.postSolvePosition(y), o.preSolveVelocity(w.list), c = 0;
                    c < n.velocityIterations;
                    c++
                  )
                    o.solveVelocity(w.list, f.timeScale);
                  return (
                ...
                t = function (e, t) {
                  ...
                  if ((0 !== t.x || 0 !== t.y) && 0 !== i)
                    for (var n = 0; n < e.length; n++) {
                      ...
                      r.isStatic ||
                        r.isSleeping ||
                        ((r.force.y += r.mass * t.y * i),
                        (r.force.x += r.mass * t.x * i));
                    }
                },
        ...
        16: [
          function (e, t, i) {
            ...
            var r = e("./Common");
            (n.on = function (e, t, i) {
              for (var n, r = t.split(" "), s = 0; s < r.length; s++)
                (n = r[s]),
                  (e.events = e.events || {}),
          ...
          function (e, t, i) {
            ...
            (n.name = "matter-js"),
              ...
              (n.before = function (e, t) {
                return (
                  (e = e.replace(/^Matter./, "")), s.chainPathBefore(n, e, t)
                );
              }),
              (n.after = function (e, t) {
                return (
                  (e = e.replace(/^Matter./, "")), s.chainPathAfter(n, e, t)
                );
              });
          },
          { "./Common": 14, "./Plugin": 20 },
        ],
        18: [function (e, t, i) {}, { "../body/Composite": 2, "./Common": 14 }],
        19: [
          function (e, t, i) {
            var n = {};
            t.exports = n;
            ...
            !(function () {
              (n.create = function (t) {
                ...
                return (
                  ...
                  (i.element = t || document.body),
                  (i.absolute = { x: 0, y: 0 }),
                  (i.position = { x: 0, y: 0 }),
                  (i.mousedownPosition = { x: 0, y: 0 }),
                  (i.mouseupPosition = { x: 0, y: 0 }),
                  (i.offset = { x: 0, y: 0 }),
                  (i.scale = { x: 1, y: 1 }),
                  (i.wheelDelta = 0),
                  (i.button = -1),
                  ...
                  (i.mousemove = function (t) {
                    ...
                    t.changedTouches && ((i.button = 0), t.preventDefault()),
                      (i.absolute.x = n.x),
                      (i.absolute.y = n.y),
              ...
              var e = function (e, t, i) {
                ...
                return (
                  c
                    ? ((n = c[0].pageX - s.left - a),
                      (r = c[0].pageY - s.top - l))
                    : ((n = e.pageX - s.left - a), (r = e.pageY - s.top - l)),
                  {
                    x: n / ((t.clientWidth / (t.width || t.clientWidth)) * i),
                    y:
                      r / ((t.clientHeight / (t.height || t.clientHeight)) * i),
                  }
                );
              };
            })();
          ...
          function (e, t, i) {
            ...
            (n._registry = {}),
              ...
              (n.isFor = function (e, t) {
                ...
                return (
                  !e.for ||
                  (t.name === i.name && n.versionSatisfies(t.version, i.range))
                );
              }),
              (n.use = function (e, t) {
                if (
                  ...
                  for (
                    var i = n.dependencies(e),
                      s = r.topologicalSort(i),
                      o = [],
                      a = 0;
                    a < s.length;
                    a += 1
                        ...
                        ? n.isUsed(e, l.name) ||
                          ...
                          l.install
                            ...
                            : (r.warn(
                              ...
                              (l._warned = !0)),
                          l._warned
                            ? (o.push("🔶 " + n.toString(l)), delete l._warned)
                            : o.push("✅ " + n.toString(l)),
                          e.used.push(l.name))
                        : o.push("❌ " + s[a]);
                    }
              ...
              (n.dependencies = function (e, t) {
                ...
                if (!(s in (t = t || {}))) {
                  (e = n.resolve(e) || e),
                    (t[s] = r.map(e.uses || [], function (t) {
                      n.isPlugin(t) && n.register(t);
                      var s = n.dependencyParse(t),
                        o = n.resolve(t);
                      return (
                        o && !n.versionSatisfies(o.version, s.range)
                          ? (r.warn(
                              "Plugin.dependencies:",
                              n.toString(o),
                              "does not satisfy",
                  ...
                  for (var o = 0; o < t[s].length; o += 1)
                    n.dependencies(t[s][o], t);
                  return t;
                }
              }),
            ...
            !(function () {
              ...
              (n.create = function (e) {
                ...
                (n.tick = function (e, t, i) {
                  ...
                  r.trigger(e, "beforeTick", l),
                    r.trigger(t, "beforeTick", l),
                    e.isFixed
                      ? (n = e.delta)
                      : ((n = i - e.timePrev || e.delta),
                        (e.timePrev = i),
                        ...
                        (e.delta = n)),
                    0 !== e.timeScalePrev &&
                      (a *= o.timeScale / e.timeScalePrev),
                    0 === o.timeScale && (a = 0),
                    (e.timeScalePrev = o.timeScale),
                    (e.correction = a),
                    (e.frameCounter += 1),
                    i - e.counterTimestamp >= 1e3 &&
                      ((e.fps =
                    ...
                    r.trigger(e, "beforeUpdate", l),
                    s.update(t, n, a),
                    r.trigger(e, "afterUpdate", l),
                    t.render &&
                      t.render.controller &&
                      (r.trigger(e, "beforeRender", l),
                      r.trigger(t, "beforeRender", l),
                      t.render.controller.world(t.render),
                      r.trigger(e, "afterRender", l),
                      r.trigger(t, "afterRender", l)),
                    r.trigger(e, "afterTick", l),
                    r.trigger(t, "afterTick", l);
                }),
                (n.stop = function (e) {
                  t(e.frameRequestId);
                }),
              ...
              (n.update = function (e, t) {
                for (var i = t * t * t, r = 0; r < e.length; r++) {
                  ...
                  if (0 === s.force.x && 0 === s.force.y) {
                    ...
                    (s.motion = n._minBias * a + (1 - n._minBias) * l),
                      s.sleepThreshold > 0 &&
                      s.motion < n._motionSleepThreshold * i
                        ? ((s.sleepCounter += 1),
                          s.sleepCounter >= s.sleepThreshold && n.set(s, !0))
                  ...
                  if (s.isActive) {
                    ...
                    if (
                      ...
                      var c = a.isSleeping && !a.isStatic ? a : l,
                        d = c === a ? l : a;
                      !c.isStatic &&
                        d.motion > n._motionWakeThreshold * i &&
                        n.set(c, !1);
                    }
                  }
                }
              ...
              (n.rectangle = function (e, t, i, n, a) {
                ...
                (n.fromVertices = function (e, t, i, n, d, u, p) {
                  ...
                  for (
                    ...
                    if (((g = i[_]), (m = r.isConvex(g)) || !c))
                      (g = m ? r.clockwiseSort(g) : r.hull(g)),
                        f.push({ position: { x: e, y: t }, vertices: g });
                    else {
                      ...
                      for (v = 0; v < S.length; v++) {
                        ...
                        (p > 0 && r.area(E) < p) ||
                          f.push({ position: r.centre(E), vertices: E });
                      }
                    }
                  for (v = 0; v < f.length; v++)
                    f[v] = o.create(s.extend(f[v], n));
                  if (d)
                    for (v = 0; v < f.length; v++) {
                      var T = f[v];
                        ...
                        if (a.overlaps(T.bounds, C.bounds)) {
                          ...
                          for (b = 0; b < T.vertices.length; b++)
                            for (w = 0; w < C.vertices.length; w++) {
                              var A = l.magnitudeSquared(
                                  l.sub(M[(b + 1) % M.length], k[w])
                                ),
                                P = l.magnitudeSquared(
                                  l.sub(M[b], k[(w + 1) % k.length])
                                );
                              A < 5 &&
                                P < 5 &&
                                ((M[b].isInternal = !0),
                  ...
                  return f.length > 1
                    ? ((h = o.create(s.extend({ parts: f.slice(0) }, n))),
                      o.setPosition(h, { x: e, y: t }),
                      h)
                    : f[0];
                });
            }).call(
                    ...
                    for (c = 0; c < t; c++)
                      (d = h[c + (l - 1) * t]),
                        ...
                        n &&
                          ...
                          r.addConstraint(
                            e,
                            s.create(o.extend({ bodyA: p, bodyB: u }, a))
                          )),
                        n &&
                          c < t - 1 &&
                          ((p = h[c + 1 + (l - 1) * t]),
          ...
          function (e, t, i) {
            ...
            (n.fromVertices = function (e) {
              for (var t = {}, i = 0; i < e.length; i++) {
                var n = (i + 1) % e.length,
                  o = r.normalise({ x: e[n].y - e[i].y, y: e[i].x - e[n].x }),
                  a = 0 === o.y ? 1 / 0 : o.x / o.y;
              ...
              (n.rotate = function (e, t) {
                if (0 !== t)
                  for (
                    var i = Math.cos(t), n = Math.sin(t), r = 0;
                    r < e.length;
                    r++
                  ) {
                    var s,
                  ...
                  for (
                    ...
                    if (/[MLHVCSQTA]/.test(h))
                      ...
                      switch (
                        ...
                        case "c":
                          a.replaceItem(
                            e.createSVGPathSegCurvetoCubicAbs(l, c, n, r, s, o),
                            u
                          );
                          break;
                        case "s":
                        ...
                        case "q":
                          a.replaceItem(
                            e.createSVGPathSegCurvetoQuadraticAbs(l, c, n, r),
                            u
                          );
                          break;
                        case "t":
        ...
        29: [
          function (e, t, i) {
            ...
            (n.create = function (e, t) {
              for (var i = [], n = 0; n < e.length; n++) {
                var r = e[n],
                  s = { x: r.x, y: r.y, index: n, body: t, isInternal: !1 };
                i.push(s);
              }
              return i;
            }),
              ...
              (n.centre = function (e) {
                for (
                  var t, i, s, o = n.area(e, !0), a = { x: 0, y: 0 }, l = 0;
                  l < e.length;
                  l++
                )
                  (s = (l + 1) % e.length),
                    (t = r.cross(e[l], e[s])),
                    (i = r.mult(r.add(e[l], e[s]), t)),
                    (a = r.add(a, i));
                return r.div(a, 6 * o);
              }),
              (n.mean = function (e) {
                for (var t = { x: 0, y: 0 }, i = 0; i < e.length; i++)
                  (t.x += e[i].x), (t.y += e[i].y);
                return r.div(t, e.length);
              }),
              (n.area = function (e, t) {
                for (var i = 0, n = e.length - 1, r = 0; r < e.length; r++)
                  (i += (e[n].x - e[r].x) * (e[n].y + e[r].y)), (n = r);
                return t ? i / 2 : Math.abs(i) / 2;
              }),
              (n.inertia = function (e, t) {
                for (var i, n, s = 0, o = 0, a = e, l = 0; l < a.length; l++)
                  (n = (l + 1) % a.length),
                    (s +=
                      (i = Math.abs(r.cross(a[n], a[l]))) *
                      (r.dot(a[n], a[n]) +
                        r.dot(a[n], a[l]) +
                        r.dot(a[l], a[l]))),
                    (o += i);
              ...
              (n.rotate = function (e, t, i) {
                if (0 !== t) {
                  for (
                    var n = Math.cos(t), r = Math.sin(t), s = 0;
                    s < e.length;
                    s++
                  ) {
                    var o = e[s],
              ...
              (n.contains = function (e, t) {
                for (var i = 0; i < e.length; i++) {
                  var n = e[i],
                    r = e[(i + 1) % e.length];
                  if ((t.x - n.x) * (r.y - n.y) + (t.y - n.y) * (n.x - r.x) > 0)
                    return !1;
                }
                return !0;
              }),
              ...
              (n.chamfer = function (e, t, i, n, o) {
                ...
                for (var a = [], l = 0; l < e.length; l++) {
                  ...
                  if (0 !== p) {
                    var h = r.normalise({ x: d.y - c.y, y: c.x - d.x }),
                      f = r.normalise({ x: u.y - d.y, y: d.x - u.x }),
                      m = Math.sqrt(2 * Math.pow(p, 2)),
                      g = r.mult(s.clone(h), p),
                      v = r.normalise(r.mult(r.add(h, f), 0.5)),
                      y = r.sub(d, r.mult(v, m)),
                      b = i;
                    -1 === i && (b = 1.75 * Math.pow(p, 0.32)),
                      (b = s.clamp(b, n, o)) % 2 == 1 && (b += 1);
                    for (var _ = Math.acos(r.dot(h, f)) / b, w = 0; w < b; w++)
                      a.push(r.add(r.rotate(g, _ * w), y));
                  } else a.push(d);
                }
                return a;
              }),
              ...
              (n.isConvex = function (e) {
                ...
                for (t = 0; t < o; t++)
                  if (
                    ((n = (t + 2) % o),
                    (r = (e[(i = (t + 1) % o)].x - e[t].x) * (e[n].y - e[i].y)),
                    (r -= (e[i].y - e[t].y) * (e[n].x - e[i].x)) < 0
                      ? (s |= 1)
                      : r > 0 && (s |= 2),
                    3 === s)
                  )
              ...
              (n.hull = function (e) {
                ...
                for (
                  ...
                  for (
                    t = e[i];
                    s.length >= 2 &&
                    r.cross3(s[s.length - 2], s[s.length - 1], t) <= 0;
                ...
                for (i = e.length - 1; i >= 0; i--) {
                  for (
                    t = e[i];
                    n.length >= 2 &&
                    r.cross3(n[n.length - 2], n[n.length - 1], t) <= 0;
            ...
            !(function () {
              ...
              "undefined" != typeof window &&
                ...
                (n.create = function (e) {
                  ...
                  return (
                    s.canvas &&
                      ((s.canvas.width = s.options.width || s.canvas.width),
                      (s.canvas.height = s.options.height || s.canvas.height)),
                    (s.mouse = e.mouse),
                    (s.engine = e.engine),
                    (s.canvas =
                    ...
                    1 !== s.options.pixelRatio &&
                      n.setPixelRatio(s, s.options.pixelRatio),
                    r.isElement(s.element)
                ...
                (n.lookAt = function (e, t, i, n) {
                  ...
                  for (
                    ...
                    l &&
                      ...
                      c.x > s.max.x && (s.max.x = c.x),
                      l.y < s.min.y && (s.min.y = l.y),
                      c.y > s.max.y && (s.max.y = c.y));
                  }
                  ...
                  m > f ? (v = m / f) : (g = f / m),
                    ...
                    (e.bounds.min.x = s.min.x),
                    (e.bounds.max.x = s.min.x + u * g),
                    (e.bounds.min.y = s.min.y),
                    (e.bounds.max.y = s.min.y + p * v),
                    n &&
                ...
                (n.world = function (e) {
                  ...
                  if (
                    (a.trigger(e, "beforeRender", _),
                    e.currentBackground !== v && h(e, v),
                    ...
                    for (t = 0; t < g.length; t++) {
                      var x = g[t],
                        ...
                        T = x.pointA,
                        C = x.pointB;
                      S && (T = c.add(S.position, x.pointA)),
                        E && (C = c.add(E.position, x.pointB)),
                        T &&
                          C &&
                          (o.contains(e.bounds, T) ||
                            o.contains(e.bounds, C)) &&
                          b.push(x);
                    }
                  ...
                  !f.wireframes || (i.enableSleeping && f.showSleeping)
                    ? n.bodies(e, y, p)
                    : (f.showConvexHulls && n.bodyConvexHulls(e, y, p),
                      n.bodyWireframes(e, y, p)),
                    f.showBounds && n.bodyBounds(e, y, p),
                    (f.showAxes || f.showAngleIndicator) && n.bodyAxes(e, y, p),
                    f.showPositions && n.bodyPositions(e, y, p),
                    f.showVelocity && n.bodyVelocity(e, y, p),
                    f.showIds && n.bodyIds(e, y, p),
                    f.showSeparations && n.separations(e, i.pairs.list, p),
                    f.showCollisions && n.collisions(e, i.pairs.list, p),
                    f.showVertexNumbers && n.vertexNumbers(e, y, p),
                    f.showMousePosition && n.mousePosition(e, e.mouse, p),
                    n.constraints(b, p),
                    f.showBroadphase &&
                      i.broadphase.controller === l &&
                      n.grid(e, i.broadphase, p),
                    f.showDebug && n.debug(e, p),
                    f.hasBounds && n.endViewTransform(e),
                    a.trigger(e, "afterRender", _);
                }),
                (n.debug = function (e, t) {
                  ...
                  if (n.timing.timestamp - (e.debugTimestamp || 0) >= 500) {
                    var c = "";
                    o.timing && (c += "fps: " + Math.round(o.timing.fps) + l),
                      (e.debugString = c),
                  ...
                  for (var i = t, n = 0; n < e.length; n++) {
                    ...
                    if (r.render.visible && r.pointA && r.pointB) {
                      ...
                      s
                        ? (i.beginPath(),
                          i.moveTo(
                            s.position.x + r.pointA.x,
                            s.position.y + r.pointA.y
                          ))
                        : (i.beginPath(), i.moveTo(r.pointA.x, r.pointA.y)),
                        o
                          ? i.lineTo(
                              o.position.x + r.pointB.x,
                              o.position.y + r.pointB.y
                            )
                          : i.lineTo(r.pointB.x, r.pointB.y),
                        r.render.lineWidth &&
                          ((i.lineWidth = r.render.lineWidth),
                  ...
                  for (var n = i, r = (e.engine, 0); r < t.length; r++) {
                    ...
                    if (s.render.visible) {
                      if (s.circleRadius)
                        ...
                        n.beginPath(),
                          n.moveTo(s.vertices[0].x, s.vertices[0].y);
                        for (var o = 1; o < s.vertices.length; o++)
                          n.lineTo(s.vertices[o].x, s.vertices[o].y);
                        n.closePath();
                      }
                        ...
                        if ((r = n.parts[o]).render.visible) {
                          if (
                            ...
                            if (r.circleRadius)
                              ...
                              for (var h = 1; h < r.vertices.length; h++)
                                !r.vertices[h - 1].isInternal || c
                                  ? a.lineTo(r.vertices[h].x, r.vertices[h].y)
                                  : a.moveTo(r.vertices[h].x, r.vertices[h].y),
                                  r.vertices[h].isInternal &&
                                    !c &&
                                    a.moveTo(
                                      r.vertices[(h + 1) % r.vertices.length].x,
                                      r.vertices[(h + 1) % r.vertices.length].y
                                    );
                    ...
                    if ((n = t[s]).render.visible)
                      for (
                        ...
                        for (
                          ...
                          !r.vertices[o - 1].isInternal || c
                            ? l.lineTo(r.vertices[o].x, r.vertices[o].y)
                            : l.moveTo(r.vertices[o].x, r.vertices[o].y),
                            r.vertices[o].isInternal &&
                              !c &&
                              l.moveTo(
                                r.vertices[(o + 1) % r.vertices.length].x,
                                r.vertices[(o + 1) % r.vertices.length].y
                              );
                ...
                (n.bodyConvexHulls = function (e, t, i) {
                  ...
                  for (o.beginPath(), r = 0; r < t.length; r++)
                    if ((n = t[r]).render.visible && 1 !== n.parts.length) {
                      for (
                        o.moveTo(n.vertices[0].x, n.vertices[0].y), s = 1;
                        s < n.vertices.length;
                        s++
                      )
                        o.lineTo(n.vertices[s].x, n.vertices[s].y);
                ...
                (n.bodyBounds = function (e, t, i) {
                  ...
                  for (var s = 0; s < t.length; s++) {
                    if (t[s].render.visible)
                      for (
                        var o = t[s].parts, a = o.length > 1 ? 1 : 0;
                        a < o.length;
                        a++
                      ) {
                        var l = o[a];
                ...
                (n.collisions = function (e, t, i) {
                  ...
                  for (
                    ...
                    if (
                      (n = t[s]).isActive &&
                      ((r = n.collision), n.activeContacts.length > 0)
                    ) {
                      ...
                      2 === n.activeContacts.length &&
                        ...
                        !0 === r.bodyA.isStatic
                          ? a.moveTo(d - 8 * r.normal.x, u - 8 * r.normal.y)
                          : a.moveTo(d + 8 * r.normal.x, u + 8 * r.normal.y),
                        a.lineTo(d, u);
                    }
                  l.wireframes
                ...
                (n.separations = function (e, t, i) {
                  ...
                  for (l.beginPath(), a = 0; a < t.length; a++)
                    if ((n = t[a]).isActive) {
                      ...
                      var d = 1;
                      (o = r.bodyB).isStatic || s.isStatic || (d = 0.5),
                        o.isStatic && (d = 0),
                        l.moveTo(o.position.x, o.position.y),
                        l.lineTo(
                          o.position.x - r.penetration.x * d,
                          o.position.y - r.penetration.y * d
                        ),
                        (d = 1),
                        o.isStatic || s.isStatic || (d = 0.5),
                        s.isStatic && (d = 0),
                        l.moveTo(s.position.x, s.position.y),
                        l.lineTo(
                          s.position.x + r.penetration.x * d,
                          s.position.y + r.penetration.y * d
                        );
                    }
                  c.wireframes
                  ...
                  if (c.hasBounds) {
                    ...
                    for (t = 0; t < u.length; t++) {
                      var y = u[t],
                        ...
                        w = y.pointA,
                        x = y.pointB;
                      b && (w = l.add(b.position, y.pointA)),
                        _ && (x = l.add(_.position, y.pointB)),
                        w &&
                          x &&
                          (r.contains(e.bounds, w) ||
                            r.contains(e.bounds, x)) &&
                          p.push(y);
                    }
                    a.scale.set(1 / m, 1 / g),
                      a.position.set(
                ...
                (n.constraint = function (e, t) {
                  ...
                  return (
                    ...
                    l.visible && t.pointA && t.pointB
                      ? (-1 === o.indexOf(a.children, d) && a.addChild(d),
                        d.clear(),
                        d.beginFill(0, 0),
                        d.lineStyle(
                          l.lineWidth,
                        ...
                        i
                          ? d.moveTo(i.position.x + r.x, i.position.y + r.y)
                          : d.moveTo(r.x, r.y),
                        n
                    ...
                    if (n.sprite && n.sprite.texture) {
                      ...
                      d ||
                        ((d = e.primitives[l] = c(e, t)).initialAngle =
                          t.angle),
                        -1 === o.indexOf(u.children, d) && u.addChild(d),
              ...
              var i = function (e, t) {
                ...
                c = function (e, t) {
                  ...
                  for (
                    ...
                    for (var h = 1; h < i.vertices.length; h++)
                      s.lineTo(
                        i.vertices[h].x - t.position.x,
                        i.vertices[h].y - t.position.y
                      );
                    s.lineTo(
                      i.vertices[0].x - t.position.x,
                      i.vertices[0].y - t.position.y
                      ...
                      (r.showAngleIndicator || r.showAxes) &&
                        (s.beginFill(0, 0),
                        r.wireframes ? s.lineStyle(1, u, 1) : s.lineStyle(1, c),
                        s.moveTo(
          ...
          r.currentTranslate > i.minTranslate() &&
            ...
            s.resistance &&
              (r.currentTranslate =
                i.minTranslate() -
                1 +
                (-i.minTranslate() + r.startTranslate + v) ** E)))
        : v < 0 &&
          (_ &&
            w &&
            !x &&
          ...
          r.currentTranslate < i.maxTranslate() &&
            ...
            s.resistance &&
              (r.currentTranslate =
                i.maxTranslate() +
                1 -
                (i.maxTranslate() - r.startTranslate - v) ** E))),
          ...
          for (let r = 0; r < h; r += 1) {
            ...
            if (
              ...
              if ("auto" === n.slidesPerView) {
                ...
                (A = (o - (n.slidesPerView - 1) * E) / n.slidesPerView),
                  n.roundLengths && (A = Math.floor(A)),
          ...
          t.params.a11y.enabled &&
            (() => {
              ...
              (p = o(p)),
                ...
                h && h.forEach((t) => b(t, s, e.prevSlideMessage)),
                v() &&
    ...
    function (e) {
      ...
      function b(e) {
        r &&
          ...
          (r.wrapperEl.removeEventListener("transitionend", b), T());
      }
      const _ = () => {
        ...
        M = (e) => {
          "mouse" === e.pointerType &&
            ((m = !0), r.animating || r.autoplay.paused || E(!0));
        },
        k = (e) => {
      ...
      o("init", () => {
        ...
        o("beforeTransitionStart", (e, t, i) => {
          !r.destroyed &&
            r.autoplay.running &&
            (i || !r.params.autoplay.disableOnInteraction ? E(!0, !0) : S());
        }),
        o("sliderFirstMove", () => {
          !r.destroyed &&
            r.autoplay.running &&
        ...
        Object.assign(r.autoplay, { start: x, stop: S, pause: E, resume: T });
    },
    function (e) {
